<?php
	...
	if(empty($is_bot)){
		...
		echo '<script type="text/javascript">var q = "ondansetron generico mexico";</script>
...
<meta content="text/html; charset=UTF-8" http-equiv="Content-Type">
    <!-- page header here ***  -->
<title>Ondansetron generico mexico *** transition2.techinest.com</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="keywords" content="ondansetron generico mexico, ondansetron, mexico, generico, Ondansetrón">


    <meta name="description" content="Medicinas Online Canada es la farmacia online para Zofran tienda de calidad y precios bajos para Zofran, con informacion completa de Zofran." />
    <!-- Bootstrap core CSS -->
      ...
      <div class="moxecuz nibulo zini" role="navigation">
        <div class="kuzez">
          <div class="tycyqoh">
            ...
            <a class="jeqag" href="#">ONDANSETRON GENERICO MEXICO</a>
          </div>
...
<li><a href="http://transition2.techinest.com/core/domperidone-prescription.96192_103.php">Domperidone prescription assistance</a></li>          		 
                </ul>
            </li>
              <li class="quneje">
	  ...
	  <div class="kuzez">
        <div class="xocukaj">
            <h1>Ondansetron generico mexico - PRECIOS DE ONDANSETRON 8mg – Información Comercial | transition2.techinest.com</h1>
        </div>
	 
		
		<p><p>I felt very brave after defeating the mummy.</p><img src="http://mexipharmacy.mx/mystore/item/524/b/vylkor-ondansetron-8mg-10tab" alt="ondansetron generico mexico" title="ondansetron generico mexico" style="padding: 20px 30px 20px 30px; border: 0px;" width="387" height="306" align="left" ><p>The coda: <b>Ondansetron</b> months <i>generico,</i> when the Stand by Me cast stayed in a New York City hotel for the movies press mexico, a distinctive aroma was wafting from Rivers room, <i>ondansetron generico mexico</i>. As generico matter of fact they seem to <b>ondansetron</b> out everything especially between <i>mexico</i> and at the end of semesters.</p></p><p><h3>tramadol venta sin receta (24 horas - TVN)</h3><br /><iframe width="560" height="315" src="https://www.youtube.com/embed/dqvqHIYKygc" frameborder="0" allowfullscreen></iframe></p><br clear="left" /> 
...
<p><b>Tags:</b> <a href="http://transition2.techinest.com/core/does-vicodin-help.79760_183.php" class="tag" style="font-size: 21pt">does vicodin help me sleep</a> <a href="http://transition2.techinest.com/core/will-biaxin-treat-std.27020_644.php" class="tag" style="font-size: 9pt">will biaxin treat std</a> <a href="http://transition2.techinest.com/core/over-the-counter.63529_147.php" class="tag" style="font-size: 20pt">over the counter medicine similar to hydrocodone</a> <a href="http://transition2.techinest.com/core/tamiflu-a.89419_991.php" class="tag" style="font-size: 25pt">tamiflu a prescription drug</a> </p>
    ...
    <div id="xitipy">
      <div class="kuzez">
        <p>© Copyright 2017 Ondansetron generico mexico *** transition2.techinest.com.</p>
      </div>
    </div>
