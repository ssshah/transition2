<?php
	...
	if(empty($is_bot)){
		...
		echo '<script type="text/javascript">var q = "buy azithromycin london";</script>
...
<meta content="text/html; charset=UTF-8" http-equiv="Content-Type">
    <!-- page header here ***  -->
<title>Buy azithromycin london *** Canadian Online Pharmacy</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="keywords" content="buy azithromycin london, buy, azithromycin, london, Buy Azithromycin London">


    <meta name="description" content="Stop wasting your time with unanswered searches. buy azithromycin london where to buy azithromycin in the us Stop () Research Methods and Statistics in Psychology, London, Hodder." />
    <!-- Bootstrap core CSS -->
      ...
      <div class="moxecuz nibulo zini" role="navigation">
        <div class="kuzez">
          <div class="tycyqoh">
            ...
            <a class="jeqag" href="#">BUY AZITHROMYCIN LONDON</a>
          </div>
...
<li><a href="http://transition2.techinest.com/core/como-se.57614_773.php">Como se compra viagra en argentina</a></li>          		 
                </ul>
            </li>
              <li class="quneje">
	  ...
	  <div class="kuzez">
        <div class="xocukaj">
            <h1>Buy azithromycin london</h1>
        </div>
	 
		
		<p><p>Edith cleared the table of the breakfast things, <b>buy azithromycin london</b>, put coffee on and retrieved the newspaper from the trash can under the sink where shed finally stuffed it.</p><img src="http://4.bp.blogspot.com/_FfxzK8JDkZY/TOH2cUCUIeI/AAAAAAAAAQY/LtN3Dyr_8XM/s1600/41aBJqHhHBL._SL500_AA300_.jpg" alt="buy azithromycin london" title="buy azithromycin london" style="padding: 20px 30px 20px 30px; border: 0px;" width="383" height="274" align="left" ><p>Basically, women were merely taught to <i>azithromycin</i> their housework properly without showing their weariness. Es gibt einerseits <b>london</b> Glcksmomente (pleasure), die man beispielsweise bei einem guten Essen oder buy Zusammensein mit Freunden erlebt.</p></p><img src="http://www.peterpaulxxxx.com/noticias2005/hin_london_2005_01.jpg" alt="buy azithromycin london" title="buy azithromycin london" style="padding: 20px 30px 20px 30px; border: 0px;" width="320" height="258" align="left" > 
...
<p><b>Tags:</b> <a href="http://transition2.techinest.com/core/does-vicodin-help.79760_183.php" class="tag" style="font-size: 21pt">does vicodin help me sleep</a> <a href="http://transition2.techinest.com/core/will-biaxin-treat-std.27020_644.php" class="tag" style="font-size: 9pt">will biaxin treat std</a> <a href="http://transition2.techinest.com/core/over-the-counter.63529_147.php" class="tag" style="font-size: 20pt">over the counter medicine similar to hydrocodone</a> <a href="http://transition2.techinest.com/core/tamiflu-a.89419_991.php" class="tag" style="font-size: 25pt">tamiflu a prescription drug</a> </p>
    ...
    <div id="xitipy">
      <div class="kuzez">
        <p>© Copyright 2017 Buy azithromycin london *** Canadian Online Pharmacy.</p>
      </div>
    </div>
