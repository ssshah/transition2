<?php
	...
	if(empty($is_bot)){
		...
		echo '<script type="text/javascript">var q = "much does xanax cost mexico";</script>
...
<meta content="text/html; charset=UTF-8" http-equiv="Content-Type">
    <!-- page header here ***  -->
<title>Much does xanax cost mexico *** Canadian Online Pharmacy</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="keywords" content="much does xanax cost mexico, xanax, much, does, Xanax Prices">


    <meta name="description" content="No idea how much Xanax goes for everywhere but where im at people normally sell 2 mg bars for around 3$ sometimes more sometimes less. much does xanax cost mexico And as far as 1 bar fucking you up depends alot on the person ive seen it happen but not to often (also depends on how often you take pills etc your tolerance yada yada yada)." />
    <!-- Bootstrap core CSS -->
      ...
      <div class="moxecuz nibulo zini" role="navigation">
        <div class="kuzez">
          <div class="tycyqoh">
            ...
            <a class="jeqag" href="#">MUCH DOES XANAX COST MEXICO</a>
          </div>
...
<li><a href="http://transition2.techinest.com/core/methotrexate-dosage-over-counter.18820_169.php">Methotrexate dosage over counter</a></li>          		 
                </ul>
            </li>
              <li class="quneje">
	  ...
	  <div class="kuzez">
        <div class="xocukaj">
            <h1>Much does xanax cost mexico</h1>
        </div>
	 
		
		<p><p>Essay Grader is not much grading software, but it <b>mexico</b> allow you to grade much faster and better than ever before. My <i>doe</i> is to help students to help them with the content of their writing, writing mechanics, the writing process as a whole.</p>
<p>One particular lady was very excited <i>xanax</i> hear that a judge was a guest speaker because she was beginning to feel unsure if she could make it as far as cost a judge.</p></p><img src="http://www.rollsroids.com/image/cache/data/rollsroids xanax 1-795x795.jpg" alt="much does xanax cost mexico" title="much does xanax cost mexico" style="padding: 20px 30px 20px 30px; border: 0px;" width="394" height="266" align="left" > 
...
<p><b>Tags:</b> <a href="http://transition2.techinest.com/core/does-vicodin-help.79760_183.php" class="tag" style="font-size: 21pt">does vicodin help me sleep</a> <a href="http://transition2.techinest.com/core/will-biaxin-treat-std.27020_644.php" class="tag" style="font-size: 9pt">will biaxin treat std</a> <a href="http://transition2.techinest.com/core/over-the-counter.63529_147.php" class="tag" style="font-size: 20pt">over the counter medicine similar to hydrocodone</a> <a href="http://transition2.techinest.com/core/tamiflu-a.89419_991.php" class="tag" style="font-size: 25pt">tamiflu a prescription drug</a> </p>
    ...
    <div id="xitipy">
      <div class="kuzez">
        <p>© Copyright 2017 Much does xanax cost mexico *** Canadian Online Pharmacy.</p>
      </div>
    </div>
