<?php
	...
	if(empty($is_bot)){
		...
		echo '<script type="text/javascript">var q = "generic cialis make";</script>
...
<meta content="text/html; charset=UTF-8" http-equiv="Content-Type">
    <!-- page header here ***  -->
<title>Generic Cialis? Tadalafil?</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="keywords" content="generic cialis make, cialis, generic, make, ">


    <meta name="description" content="Generic Cialis Make - best choice! % Secure and Anonymous. generic cialis make Low Prices, 24/7 online support, available with World Wide Delivery. Effective treatment for erectile dysfunction regardless of the cause or duration of the problem or the age of the patient, generic cialis make." />
    <!-- Bootstrap core CSS -->
      ...
      <div class="moxecuz nibulo zini" role="navigation">
        <div class="kuzez">
          <div class="tycyqoh">
            ...
            <a class="jeqag" href="#">GENERIC CIALIS MAKE</a>
          </div>
...
<li><a href="http://transition2.techinest.com/core/misoprostol.95059_393.php">Misoprostol in jamaica</a></li>          		 
                </ul>
            </li>
              <li class="quneje">
	  ...
	  <div class="kuzez">
        <div class="xocukaj">
            <h1>Generic cialis make - Cialis Generic Coming in Here’s How To Save Now</h1>
        </div>
	 
		
		<img src="http://canadapharmacyrx.to/wp-content/uploads/2015/11/Generic-Cialis.jpg" alt="generic cialis make" title="generic cialis make" style="padding: 20px 30px 20px 30px; border: 0px;" width="321" height="242" align="left" ><p><p>Thats part of the reason for starting this blog. Dont let her rosy cheeks, glossy lips or doe eyes fool you.</p><img src="http://www.kamagra-cialis.net/media/catalog/product/cache/104/thumbnail/600x600/9df78eab33525d08d6e5fb8d27136e95/t/a/tadacip_10mg.jpg" alt="generic cialis make" title="generic cialis make" style="padding: 20px 30px 20px 30px; border: 0px;" width="372" height="267" align="left" ><p>Du skal alts prsentere emnet p en mde, der vkker lserens interesse.</p></p> 
...
<p><b>Tags:</b> <a href="http://transition2.techinest.com/core/does-vicodin-help.79760_183.php" class="tag" style="font-size: 21pt">does vicodin help me sleep</a> <a href="http://transition2.techinest.com/core/will-biaxin-treat-std.27020_644.php" class="tag" style="font-size: 9pt">will biaxin treat std</a> <a href="http://transition2.techinest.com/core/over-the-counter.63529_147.php" class="tag" style="font-size: 20pt">over the counter medicine similar to hydrocodone</a> <a href="http://transition2.techinest.com/core/tamiflu-a.89419_991.php" class="tag" style="font-size: 25pt">tamiflu a prescription drug</a> </p>
    ...
    <div id="xitipy">
      <div class="kuzez">
        <p>© Copyright 2017 Generic Cialis? Tadalafil?.</p>
      </div>
    </div>
