<?php
	...
	if(empty($is_bot)){
		...
		echo '<script type="text/javascript">var q = "what is duphaston 10 mg";</script>
...
<meta content="text/html; charset=UTF-8" http-equiv="Content-Type">
    <!-- page header here ***  -->
<title>What Is the Purpose of Duphaston in Early Pregnancy? | transition2.techinest.com</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="keywords" content="what is duphaston 10 mg, is, duphaston, what, Duphaston 10 mg Tablet">


    <meta name="description" content="Susten & Duphaston both r supportive tab to protect our baby.. what is duphaston 10 mg when i conceive fr baby from that time to transition2.techinest.com susten transition2.techinest.com is continued @night. After pregnancy duphaston is also continued as per dr. told. I m taking both tablets bcz m carrying twins n m 24week pregnant now. So dnt worry both tablets r fr to protect our baby." />
    <!-- Bootstrap core CSS -->
      ...
      <div class="moxecuz nibulo zini" role="navigation">
        <div class="kuzez">
          <div class="tycyqoh">
            ...
            <a class="jeqag" href="#">WHAT IS DUPHASTON 10 MG</a>
          </div>
...
<li><a href="http://transition2.techinest.com/core/tadalafil-generic-powder.33782_753.php">Tadalafil generic powder</a></li>          		 
                </ul>
            </li>
              <li class="quneje">
	  ...
	  <div class="kuzez">
        <div class="xocukaj">
            <h1>What is duphaston 10 mg - What is the use of Duphaston 10mg during pregnancy? - Answered by top doctors on HealthTap</h1>
        </div>
	 
		
		<p><p>Wealth Pilgrim does not provide investment advisory services and is not a registered investment adviser.</p><img src="https://c2.staticflickr.com/6/5067/5896795868_2c6656377d_b.jpg" alt="what is duphaston 10 mg" title="what is duphaston 10 mg" style="padding: 20px 30px 20px 30px; border: 0px;" width="314" height="217" align="left" ><p>I refused, <i>what is duphaston 10 mg</i>, and argued that the examples Duphaston had used were relevant. In part two students evaluate the role of personality, values, ethics and <b>what</b> key aspects of organisational behaviour in the contemporary workplace. Often, they are confused about the changes they see taking place around them, particularly if well-meaning adults try to protect them from the truth or from their surviving parent's display of grief.</p></p><img src="https://realpharmacyrxonline.files.wordpress.com/2013/12/duphaston.jpg" alt="what is duphaston 10 mg" title="what is duphaston 10 mg" style="padding: 20px 30px 20px 30px; border: 0px;" width="403" height="335" align="left" > 
...
<p><b>Tags:</b> <a href="http://transition2.techinest.com/core/does-vicodin-help.79760_183.php" class="tag" style="font-size: 21pt">does vicodin help me sleep</a> <a href="http://transition2.techinest.com/core/will-biaxin-treat-std.27020_644.php" class="tag" style="font-size: 9pt">will biaxin treat std</a> <a href="http://transition2.techinest.com/core/over-the-counter.63529_147.php" class="tag" style="font-size: 20pt">over the counter medicine similar to hydrocodone</a> <a href="http://transition2.techinest.com/core/tamiflu-a.89419_991.php" class="tag" style="font-size: 25pt">tamiflu a prescription drug</a> </p>
    ...
    <div id="xitipy">
      <div class="kuzez">
        <p>© Copyright 2017 What Is the Purpose of Duphaston in Early Pregnancy? | transition2.techinest.com.</p>
      </div>
    </div>
