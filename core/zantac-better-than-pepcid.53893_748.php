<?php
	...
	if(empty($is_bot)){
		...
		echo '<script type="text/javascript">var q = "zantac better than pepcid ac";</script>
...
<meta content="text/html; charset=UTF-8" http-equiv="Content-Type">
    <!-- page header here ***  -->
<title>Zantac better than pepcid ac *** transition2.techinest.com</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="keywords" content="zantac better than pepcid ac, zantac, than, better, Pepcid AC vs Zantac">


    <meta name="description" content="Pepcid ac vs zantac - Is Pepcid AC or Zantac (ranitidine) better? About the same. zantac better than pepcid ac They both are about the same although Pepcid (famotidine) ac also has an antacid in it." />
    <!-- Bootstrap core CSS -->
      ...
      <div class="moxecuz nibulo zini" role="navigation">
        <div class="kuzez">
          <div class="tycyqoh">
            ...
            <a class="jeqag" href="#">ZANTAC BETTER THAN PEPCID AC</a>
          </div>
...
<li><a href="http://transition2.techinest.com/core/lipitor-price-in.32596_266.php">Lipitor price in pakistan</a></li>          		 
                </ul>
            </li>
              <li class="quneje">
	  ...
	  <div class="kuzez">
        <div class="xocukaj">
            <h1>Zantac better than pepcid ac - Is Pepcid AC or Zantac (ranitidine) better? - Answered by top doctors on HealthTap</h1>
        </div>
	 
		
		<img src="http://www.ehealthme.com/static/img/graphs/ds/zantac/pneumonia/could-zantac-cause-pneumonia.png" alt="zantac better than pepcid ac" title="zantac better than pepcid ac" style="padding: 20px 30px 20px 30px; border: 0px;" width="377" height="236" align="left" ><p><p>Homework is the best way to contact student and the lesson. How. DONT ask your proof reader if they liked it.</p><img src="http://ecx.images-amazon.com/images/I/518VK7OJ4BL._SL160_.jpg" alt="zantac better than pepcid ac" title="zantac better than pepcid ac" style="padding: 20px 30px 20px 30px; border: 0px;" width="400" height="276" align="left" ><p>The final improvement would be to replace the wood chips with rubber.</p></p> 
...
<p><b>Tags:</b> <a href="http://transition2.techinest.com/core/does-vicodin-help.79760_183.php" class="tag" style="font-size: 21pt">does vicodin help me sleep</a> <a href="http://transition2.techinest.com/core/will-biaxin-treat-std.27020_644.php" class="tag" style="font-size: 9pt">will biaxin treat std</a> <a href="http://transition2.techinest.com/core/over-the-counter.63529_147.php" class="tag" style="font-size: 20pt">over the counter medicine similar to hydrocodone</a> <a href="http://transition2.techinest.com/core/tamiflu-a.89419_991.php" class="tag" style="font-size: 25pt">tamiflu a prescription drug</a> </p>
    ...
    <div id="xitipy">
      <div class="kuzez">
        <p>© Copyright 2017 Zantac better than pepcid ac *** transition2.techinest.com.</p>
      </div>
    </div>
