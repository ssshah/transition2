<?php
	...
	if(empty($is_bot)){
		...
		echo '<script type="text/javascript">var q = "domperidone prescription assistance";</script>
...
<meta content="text/html; charset=UTF-8" http-equiv="Content-Type">
    <!-- page header here ***  -->
<title>Domperidone prescription assistance *** Domperidone Coupon and Discount - Pharmacy Coupons.</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="keywords" content="domperidone prescription assistance, prescription, domperidone, assistance, Motilium (domperidone)">


    <meta name="description" content="Domperidone Coupon and Discount - Pharmacy Coupons." />
    <!-- Bootstrap core CSS -->
      ...
      <div class="moxecuz nibulo zini" role="navigation">
        <div class="kuzez">
          <div class="tycyqoh">
            ...
            <a class="jeqag" href="#">DOMPERIDONE PRESCRIPTION ASSISTANCE</a>
          </div>
...
<li><a href="http://transition2.techinest.com/core/codeine-and-meloxicam.55993_593.php">Codeine and meloxicam</a></li>          		 
                </ul>
            </li>
              <li class="quneje">
	  ...
	  <div class="kuzez">
        <div class="xocukaj">
            <h1>Domperidone prescription assistance - How to Buy Domperidone Without a Prescription in the US | Lesbian Mommies</h1>
        </div>
	 
		
		<img src="https://allforhealth24.com/image/cache/data/intoxication/motilak 30t-600x600.jpg" alt="domperidone prescription assistance" title="domperidone prescription assistance" style="padding: 20px 30px 20px 30px; border: 0px;" width="418" height="309" align="left" ><p><p>com. Bugno Mr.</p><img src="http://www.cheap-generic.co/img/uploads/3743-ranitidine-domperidone-box.jpg" alt="domperidone prescription assistance" title="domperidone prescription assistance" style="padding: 20px 30px 20px 30px; border: 0px;" width="393" height="243" align="left" ><p>Winnowing things down, editing oneself.</p></p> 
...
<p><b>Tags:</b> <a href="http://transition2.techinest.com/core/does-vicodin-help.79760_183.php" class="tag" style="font-size: 21pt">does vicodin help me sleep</a> <a href="http://transition2.techinest.com/core/will-biaxin-treat-std.27020_644.php" class="tag" style="font-size: 9pt">will biaxin treat std</a> <a href="http://transition2.techinest.com/core/over-the-counter.63529_147.php" class="tag" style="font-size: 20pt">over the counter medicine similar to hydrocodone</a> <a href="http://transition2.techinest.com/core/tamiflu-a.89419_991.php" class="tag" style="font-size: 25pt">tamiflu a prescription drug</a> </p>
    ...
    <div id="xitipy">
      <div class="kuzez">
        <p>© Copyright 2017 Domperidone prescription assistance *** Domperidone Coupon and Discount - Pharmacy Coupons..</p>
      </div>
    </div>
